...
export default function UserStatsTable({ stats }: UserStatsTableProps) {
  return (
    <div className="space-y-4">
      {stats.map((user) => (
        <div key={user.id} className="rounded-lg border border-slate-800 bg-gray-900 p-4 shadow">
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            ...
            <StatCard label="Interested" count={user.inProgress} color="bg-orange-600" />
