      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center px-4 py-8">
            <Dialog.Panel className="w-full max-w-lg rounded-lg bg-[#1c1c1e] p-6 text-white shadow-xl border border-gray-700">
              <Dialog.Title className="text-lg font-semibold mb-4">Assign Service</Dialog.Title>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <textarea
                    className="w-full bg-[#111] border border-gray-600 text-white min-h-[120px] rounded px-3 py-2"
                    placeholder={":point_right: BASIC LOGO PACKAGE: $59\n3 Unique Custom Logo Concepts\n5 Revisions..."}
                    value={description}
