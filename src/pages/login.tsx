...
export default function LoginPage() {
  ...
  const handleLogin = async (e?: React.FormEvent) => {
    ...
    if (profileError || !profile) {
      ...
      toast.error('Login exists, but this account has no app profile or role. Ask admin to recreate or repair this user.')
      setLoading(false)
      return
    }
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-[#1c1c1e] text-white">
      ...
      <div className="flex flex-col justify-center px-10 py-16 md:px-20">
        ...
        {/* Forgot password will be enabled after the role/login flow is finalized. */}
        {false && (
